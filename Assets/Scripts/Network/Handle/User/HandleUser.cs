...
public class HandleUser
{
    ...
    public static void HandleTavern(SFSObject packet)
    {
        ...
        if (ec == CmdDefine.ErrorCode.SUCCESS)
        {
            C_Enum.CardType type = (C_Enum.CardType)packet.GetInt(CmdDefine.ModuleUser.TYPE_TAVERN);

            M_Character character = new M_Character(packet.GetSFSObject(CmdDefine.ModuleUser.CHARACTER), C_Enum.ReadType.SERVER);
            character.lv = 1;
